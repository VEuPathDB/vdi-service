...
) : DatasetFileImpl(S3Paths.DELETE_FLAG_FILE_NAME, path, existsChecker, lastModifiedSupplier, loadObjectStream)
, DatasetDeleteFlagFile {
    ...
    constructor(s3Object: S3Object) : this(
        ...
        if (s3Object.baseName != S3Paths.DELETE_FLAG_FILE_NAME) {
            throw IllegalArgumentException(
                "Can only construct a delete flag from s3 object if object base name is "
                        + S3Paths.DELETE_FLAG_FILE_NAME + ". Actual name: " + s3Object.baseName
            )
        }
    }
}