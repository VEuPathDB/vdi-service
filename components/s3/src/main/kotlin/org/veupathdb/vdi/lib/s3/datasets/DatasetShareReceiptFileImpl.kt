...
internal class DatasetShareReceiptFileImpl(path: String,
                                           existsChecker: () -> Boolean,
                                           lastModifiedSupplier: () -> OffsetDateTime?,
                                           loadObjectStream: () -> InputStream?)
: DatasetFileImpl(S3Paths.SHARE_RECEIPT_FILE_NAME, path, existsChecker, lastModifiedSupplier, loadObjectStream)
