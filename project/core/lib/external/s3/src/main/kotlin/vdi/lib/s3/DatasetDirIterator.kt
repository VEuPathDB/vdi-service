    ...
    while (true) {
      ...
      if (!objectStream.hasNext()) {
        ...
        if (stagedObjects.isNotEmpty()) {
          ...
          try {
            return MaterializedDatasetDirectory.build(stagedObjects, userID, datasetID, pathFactory)
      ...
      if (currDatasetID == nextObjectDatasetID) {
        ...
        try {
          ...
          return MaterializedDatasetDirectory.build(stagedObjects, currUserID, currDatasetID, pathFactory)
        } catch (e: MalformedDatasetException) {
