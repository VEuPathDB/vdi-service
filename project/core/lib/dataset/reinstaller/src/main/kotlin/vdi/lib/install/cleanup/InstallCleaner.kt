...
object InstallCleaner {
   ...
   * status.
   */
  private fun maybeCleanDatasetFromTargetDB(datasetID: DatasetID, installTarget: InstallTargetID, dataType: DataType) {
    try {
  ...
  private fun cleanTarget(datasetID: DatasetID, installTarget: InstallTargetID, dataType: DataType) {
