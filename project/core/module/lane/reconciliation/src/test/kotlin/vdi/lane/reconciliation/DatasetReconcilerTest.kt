...
class DatasetReconcilerTest {
  ...
  private val dsType = DatasetType(DataType.of("foo"), "bar")
    ...
    fun test0() {
      ...
      val transaction = mockCacheDBTransaction(
        ...
        onInsertMeta = { id, meta ->
          ...
          assertEquals(DatasetVisibility.Protected, meta.visibility)
...
private fun generateFileInfo(): DatasetFileInfo =
  DatasetFileInfo(
