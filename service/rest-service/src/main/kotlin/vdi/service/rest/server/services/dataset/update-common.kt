...
fun VDIDatasetMeta.applyPatch(
  ...
  VDIDatasetMeta(
    ...
    sourceURL        = sourceURL,
    created          = created,
    publications     = patch.publications.applyPatch(publications, vdi.service.rest.generated.model.DatasetPublication::toInternal),
    hyperlinks       = patch.hyperlinks.applyPatch(hyperlinks, vdi.service.rest.generated.model.DatasetHyperlink::toInternal),
    contacts         = patch.contacts.applyPatch(contacts, vdi.service.rest.generated.model.DatasetContact::toInternal),
