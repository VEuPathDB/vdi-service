...
internal fun updateDatasetMeta(userID: UserID, datasetID: DatasetID, patch: DatasetPatchRequestBody): PatchDatasetsByVdiIdResponse {
  ...
  patch.validate(dataset.projects)
    ...
    ?.also { return respond422WithApplicationJson(UnprocessableEntityError(it)) }
  ...
  cacheDB.withTransaction { db ->
    VDIDatasetMeta(
      ...
      DatasetStore.putDatasetMeta(userID, datasetID, meta)
      db.updateDatasetMeta(datasetID, meta)
    }
  }
