...
fun DatasetMetaBase.validate(errors: ValidationErrors) {
  ...
  projectIds.validateProjects(JsonField.META..JsonField.DEPENDENCIES, errors)
  dependencies.validate(JsonField.META..JsonField.DEPENDENCIES, errors)

  // Optional Fields
  category.validateCategory(JsonField.META..JsonField.CATEGORY, errors)
...
private fun DatasetMetaBase.validateProperties(errors: ValidationErrors) {
  ...
  projectIds.forEachIndexed { i, it ->
    when {
      schema == null -> {
        owner = it
