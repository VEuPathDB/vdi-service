...
ADMIN_SECRET_KEY=someAdminSecretKey
...
| ADMIN_SECRET_KEY
| String
| Secret key value used to authenticate requests to administration endpoints.

|
| MAX_UPLOAD_FILE_SIZE
| uint64
| Max file size allowed for a single upload.

|
| USER_UPLOAD_QUOTA
| uint64
| Quota cap for an individual user's total uploads.
