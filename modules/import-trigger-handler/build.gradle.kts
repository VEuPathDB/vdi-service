...
dependencies {
  ...
  implementation("org.veupathdb.vdi:vdi-component-s3:1.1.0-SNAPSHOT") { isChanging = true }
  ...
  implementation("org.veupathdb.vdi:vdi-component-handler-client:1.0.0-SNAPSHOT") { isChanging = true }
